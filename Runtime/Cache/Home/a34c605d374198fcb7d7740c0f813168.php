...
<title>访友|笔记|<?php echo ($row["title"]); ?></title>
...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_middle_sub">
     ...
     <div id="templatemo_main">
     	<div >
            <a href="__URL__/edit/id/<?php echo ($row["id"]); ?>" title="修改"><li class="icon-pencil"></li></a>
            <a href="__URL__/destroy/id/<?php echo ($row["id"]); ?>" title="删除"><li class="icon-remove"></li></a>
        </div><br/>
        <h4>标题:</h4><p><?php echo ($row["title"]); ?></p>
        <h4>内容:</h4>
