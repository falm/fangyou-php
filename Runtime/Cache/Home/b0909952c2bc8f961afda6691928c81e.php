...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_middle_sub">
     ...
     <div id="templatemo_main">
     	<form id="note" name="note" action="__URL__/update" method="post">
        	标题：<input name="title" type="text" value="<?php echo ($row["title"]); ?>"/><br/>
            内容：<textarea id="notecontent" name="content"><?php echo ($row["content"]); ?></textarea><br/>
